...
public class MavenCreateProject {
	...
	public static String createProjectWithMavenCore(Project project,
		...
		String[] args = new String[] { "org.apache.maven.plugins:maven-archetype-plugin:2.0-alpha-4:generate",
				"-DarchetypeGroupId=org.apache.wicket",
				"-DarchetypeArtifactId=wicket-archetype-quickstart",
				"-DarchetypeVersion=1.3.3", "-DgroupId=org.jabox",
				"-Dversion=1.0.0-SNAPSHOT", "-Dpackage=org.jabox",
				"-Duser.dir=" + baseDir, "-DartifactId=" + project.getName() ,"-DinteractiveMode=false"};
